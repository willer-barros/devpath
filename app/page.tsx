        ...
        <footer className={styles.footer}>
          <div className={styles.footerText}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', flexWrap: 'wrap' }}>
              ...
              <a href={process.env.NEXT_PUBLIC_LINK_GITHUB} target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
                <GithubIcon />
              </a>
              <span>e participe na nossa comunidade no</span>
              <a href={process.env.NEXT_PUBLIC_LINK_DISCORD} target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
                <DiscordIcon />
              </a>
            </div>
          </div>
